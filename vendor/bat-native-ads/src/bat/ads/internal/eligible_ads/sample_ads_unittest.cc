...
TEST(BatAdsSampleAdsTest,
  ...
  creative_ad_predictors[creative_ad_notification_1.creative_instance_id] =
      ad_predictor_1;
  ...
  creative_ad_predictors[creative_ad_notification_2.creative_instance_id] =
      ad_predictor_2;
  ...
  creative_ad_predictors[creative_ad_notification_3.creative_instance_id] =
      ad_predictor_3;

  // Act
  for (int i = 0; i < 10; i++) {
    const CreativeAdNotificationInfo expected_creative_ad =
